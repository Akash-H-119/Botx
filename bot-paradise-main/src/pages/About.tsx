...
const About = () => {
  useEffect(() => { document.title = "About — Quro"; }, []);
  return (
    <SiteLayout>
      <div className="container py-16 max-w-3xl">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          <p>Quro is a curated marketplace for production-ready algorithmic trading bots. Every strategy on our platform is reviewed by quant engineers, backtested on multi-year datasets, and ships with full source code.</p>
          ...
          <p>Whether you're scalping perpetuals, running market-making across CEXes, or chasing trends with ML models, Quro is where the best strategies live.</p>
        </div>
      </div>
    </SiteLayout>
  );
